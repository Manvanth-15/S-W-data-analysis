...
Prediction
'''
data.hist(bins=50,figsize=(10,30))
plt.show()

data["TotalMinutes"] = data["VeryActiveMinutes"] + data["FairlyActiveMinutes"] + data["LightlyActiveMinutes"] + data["SedentaryMinutes"]
data.plot(kind='scatter',x ="TotalMinutes" , y = 'Calories' ,alpha=0.1)
plt.show()

cor_df = data.corr()
print(cor_df['Calories'].sort_values(ascending=False))
'''
from pandas.plotting import scatter_matrix
att = ['Id','ActivityDate','TotalSteps','TotalDistance','TrackerDistance','LoggedActivitiesDistance','VeryActiveDistance','ModeratelyActiveDistance',
...
scatter_matrix(data[att],figsize=(18,12))
plt.show()
'''
...
le = LabelEncoder()
X_train['ActivityDate'] = le.fit_transform(X_train['ActivityDate'])
X_test['ActivityDate'] = le.fit_transform(X_test['ActivityDate'])
...
print("Accuracy Score of linear regression: ",score)
